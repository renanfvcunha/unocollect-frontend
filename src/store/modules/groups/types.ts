...
export enum GroupsTypes {
  ...
  DELETE_GROUP_REQUEST = '@categories/DELETE_GROUP_REQUEST',
  DELETE_GROUP_SUCCESS = '@categories/DELETE_GROUP_SUCCESS',
  DELETE_GROUP_FAILURE = '@categories/DELETE_GROUP_FAILURE',
