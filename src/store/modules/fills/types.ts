...
export enum FillsTypes {
  ...
  GET_USERS_IMAGES_REQUEST = '@fills/GET_USERS_IMAGES_REQUEST',
  GET_USERS_IMAGES_SUCCESS = '@fills/GET_USERS_IMAGES_SUCCESS',
  GET_USERS_IMAGES_FAILURE = '@fills/GET_USERS_IMAGES_FAILURE',
}
